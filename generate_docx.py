...
def create_docx():
    ...
    # Title
    title = doc.add_heading('EasyDocs - Viva Questions Bank', level=1)
    title.alignment = WD_ALIGN_PARAGRAPH.CENTER
    
    # Subtitle
    subtitle = doc.add_paragraph('Comprehensive questions for Backend, Frontend, and AI Pipeline')
    ...
    # Section 1
    h1 = doc.add_heading('Section 1: Frontend & Backend Technologies (25 Questions)', level=2)
    ...
    # Section 2
    h2 = doc.add_heading('Section 2: Overall Working, Concepts & AI Pipeline (25 Questions)', level=2)
    for q in questions_part2:
        p = doc.add_paragraph(q)
        
    doc.save('EasyDocs_Viva_Questions.docx')
